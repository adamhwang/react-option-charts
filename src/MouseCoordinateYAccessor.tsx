...
export class MouseCoordinateYAccessor extends React.Component<MouseCoordinateYAccessorProps> {
    ...
    private readonly helper = (props: MouseCoordinateYAccessorProps, moreProps: any) => {
        const {
            chartConfig: { yScale },
            chartId,
            currentItem,
